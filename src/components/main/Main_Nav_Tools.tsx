...
export default function Main_Nav_Tools({
	variant = "desktop",
}: {
	...
	const { isMenuOpen, isCartOpen, isSearchOpen } = useSelector(
	...
	return (
		<ul
			className={
				"Main_Nav_Tools " +
				(variant === "desktop" ? "Desktop_Nav_Tools" : "Mobile_Nav_Tools")
			}
		>
			...
			<li className="Nav_Tool_Container">
				<a
					className={
						"Nav_Tool Menu_Btn Icon" + (isSearchOpen ? " active " : "")
					}
					href="#"
			...
			<li className="Menu_Btn_Container">
				<a
					className={"Nav_Tool Menu_Btn Icon" + (isMenuOpen ? " active " : "")}
					href="#menu"
					title="Abrir o Menu"
