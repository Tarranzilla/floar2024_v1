...
export default function Sobre() {
    return (
        <m.div variants={basicFade} initial="hidden" animate="visible" exit="hidden" className="Main_Sobre" key="Sobre">
            <Image src="/Joice/Joice_1.jpg" alt="Joice Fregapane, Designer e Artista" width={420} height={840} className="Sobre_Image Joice_Image" />
            ...
            <div className="Sobre_Text_Content">
                ...
                <p className="Sobre_Paragrafo">
                    Aprendi a costurar com minha mãe aos 10 anos de idade. Fiz cursos de modelagem e costura mas onde aprendi mesmo foi convivendo e
                    tendo aulas práticas de alta costura com uma mulher incrível, Dona Nadir, com quem aprendi muito sobre costura e sobre a vida.
                    Desde então segui fazendo roupas para a família e para amigos.
                </p>
                <p className="Sobre_Paragrafo">
                    Fiz alguns figurinos para amigos artistas, sempre me divertindo muito e com muito encantamento pela transformação de um simples
                    pedaço de tecido em roupas que fazem com que as pessoas sintam-se bonitas e confortáveis.
                </p>
                <p className="Sobre_Paragrafo">
                    Hoje a paixão por costurar fez com que eu criasse a Floar, onde me realizo fazendo roupas com muito cuidado, amor e consciência,
                    entendendo que vestir é um ato político e que as pessoas não usam roupas só para cobrir o corpo ou se protegerem e, sim para
                    expressarem-se de forma livre e autêntica.
                </p>
                <p className="Sobre_Paragrafo">
                ...
                <p className="Sobre_Paragrafo">
                    ...
                    espero que o descarte daquilo que não nos serve mais seja feito de modo responsável na tentativa de diminuir os danos à natureza
                </p>
